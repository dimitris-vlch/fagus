    ...
    # Βήμα 11: Η συνάρτηση προσπαθεί να αναγνώσει το αρχείο json και να το μετατρέψει σε αντικείμενο python, τη λίστα data.
      try:
        with open(json_file, "r", encoding="utf-8") as file:
            ...
            except Exception as e: print(f"Σφάλμα κατά την ανάγνωση του αρχείου: {e}")
...
# Βήμα 1?: Καλούμε τις συνάρτησεις, προκειμένου να μετρήσουμε τον αριθμό των δειγμάτων, καθώς και τον αριθμό των δειγμάτων που παρουσιάζουν τοποθεσία, για τη μεταβλητή json_file.
